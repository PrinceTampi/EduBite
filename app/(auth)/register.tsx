    ...
    <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView style={styles.flex} contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Join EduBite and learn something new daily</Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.formGroup}>
            ...
            <TextInput
              ...
              placeholder="Create a password (min 6 chars)" placeholderTextColor="#9ca3af"
              secureTextEntry
            />
          </View>
...
const styles = StyleSheet.create({
  ...
  logoIcon: {
    width: 80, height: 80, borderRadius: 24, backgroundColor: '#58CC02',
  ...
  subtitle: { fontSize: 15, color: '#6b7280', marginTop: 8, fontWeight: '500', textAlign: 'center' },
  ...
  successBox: { backgroundColor: '#f0fdf4', padding: 12, borderRadius: 10, marginBottom: 16 },
  ...
  btn: {
    backgroundColor: '#58CC02', borderRadius: 12, padding: 16, alignItems: 'center', marginTop: 8,
